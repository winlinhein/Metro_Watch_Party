                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                    <template x-for="movie in filteredMovies" :key="movie.id">
                        <div class="group relative aspect-[2/3] rounded-2xl overflow-hidden cursor-pointer bg-white/5" 
                            ...
                            <div class="absolute inset-0 bg-red-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px] z-20">
                                <div class="w-12 h-12 rounded-full bg-red-500 flex items-center justify-center shadow-lg transform scale-50 group-hover:scale-100 transition-transform duration-300 delay-100">
                                    <span class="material-symbols-outlined text-white pl-1">play_arrow</span>
                                </div>
                            </div>
                        </div>
                    </template>
