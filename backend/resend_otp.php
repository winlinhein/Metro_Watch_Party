...
if (empty($email)) {
 ...
 // Generate 6-digit OTP & Expiration
    try{
        ...
        // Insert new OTP into `otps` table (Note: mapped column 'expires_at')
        ...
        // 🟢 ADD THIS BLOCK FOR LOCALHOST / XAMPP:
        ...
        header("Location: ../frontend/otp-login.php?success=" . urlencode("A new verification code has been sent to your email."));
        exit();
        ...
        header("Location: ../frontend/otp-login.php?error=" . urlencode("Failed to send new code. Please try again later."));
        exit();
    }
?>