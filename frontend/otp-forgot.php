        ...
        <div class="glass-card rounded-2xl p-8 ultimate-reveal border-red-500/20 shadow-[0_0_50px_rgba(239,68,68,0.1)]" id="glass-card">
            ...
            <div class="text-center gs-stagger mt-8 flex flex-col gap-4">
                ...
                <div class="relative w-full max-w-[200px] mx-auto h-1.5 bg-white/5 rounded-full overflow-hidden shadow-[inset_0_1px_3px_rgba(0,0,0,0.5)]">
                    <div class="absolute top-0 left-0 h-full bg-gradient-to-r from-yellow-500 to-red-600 rounded-full transition-all duration-1000 ease-linear shadow-[0_0_10px_rgba(239,68,68,0.5)]"
                         :style="`width: ${(timeLeft / 180) * 100}%`"></div>
                </div>

                <div class="flex items-center justify-center gap-3">
                    <p class="text-gray-400 text-sm flex items-center gap-2">
                        <span class="material-symbols-outlined text-[16px] text-yellow-500" x-show="timeLeft > 0">timer</span>
                    ...
                    <button 
                        ...
                        :class="timeLeft > 0 ? 'text-white/20 cursor-not-allowed' : 'text-white hover:text-yellow-500 cursor-pointer'"
                    >
                        Resend
                        <span x-ref="resendIcon" class="material-symbols-outlined text-[14px]">refresh</span>
                        <div x-show="timeLeft === 0" class="absolute -bottom-1 left-0 w-full h-[1px] bg-gradient-to-r from-yellow-500 to-transparent origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                    </button>
                </div>
