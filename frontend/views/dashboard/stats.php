        ...
        <template x-for="i in 4" :key="'stat-skeleton-' + i">
            <div class="glass-card p-6 rounded-2xl animate-pulse">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <div class="w-12 h-6 rounded-md bg-white/10"></div>
                </div>
                <div class="h-10 w-24 bg-white/10 rounded mb-2"></div>
            ...
            <div class="glass-card p-6 rounded-2xl stagger-item gs-stat-card group hover:border-white/20 transition-colors cursor-default">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <span class="text-xs font-bold px-2.5 py-1 rounded-md border"
                          :class="stat.change.startsWith('-') ? 'bg-red-500/10 text-red-400 border-red-500/20' : 'bg-green-500/10 text-green-400 border-green-500/20'"
