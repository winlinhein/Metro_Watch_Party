...
<div data-tab-panel="reports" style="display: none; padding-top: 7.5rem;" class="absolute inset-0 px-10 pb-10 w-full min-h-full overflow-y-auto">
    ...
    <!-- Stats Row -->
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8 stagger-item">
        ...
        <div class="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden group hover:border-orange-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20 hover:-translate-y-1">
            ...
            <div class="relative z-10 w-full flex items-center justify-between">
                <div>
                    <p class="text-white/40 text-xs font-bold uppercase tracking-wider mb-1">Pending</p>
        ...
        <div class="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden group hover:border-sky-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-sky-500/20 hover:-translate-y-1">
            ...
            <div class="absolute left-0 top-0 bottom-0 w-1 bg-sky-500 shadow-[0_0_10px_rgba(14,165,233,0.8)]"></div>
            <div class="relative z-10 w-full flex items-center justify-between">
                <div>
                    <p class="text-white/40 text-xs font-bold uppercase tracking-wider mb-1">Read</p>
        ...
        <div class="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden group hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1">
            ...
            <div class="relative z-10 w-full flex items-center justify-between">
                <div>
                    <p class="text-white/40 text-xs font-bold uppercase tracking-wider mb-1">Resolved</p>
                    <h3 class="text-3xl font-bold text-white" x-text="reportStats?.resolved || 0"></h3>
                </div>
                        ...
                        <tr class="hover:bg-white/5 border-b border-white/5 transition-colors group">
                            ...
                            <td class="p-5 text-center">
                                <span class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider"
                                      :class="isReportCancelled(report)
                ...
                <template x-if="selectedReport">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3 justify-end">
                            ...
                            <button @click="dismissReport()" class="px-5 py-2.5 rounded-xl border border-white/10 text-white/70 hover:bg-white/5 hover:text-white transition-colors text-sm font-bold">
                                Dismiss
                            </button>
                            <button x-show="isReportActionable(selectedReport)" :disabled="reportActionBusy" @click="cancelReport()" class="px-5 py-2.5 rounded-xl border border-red-500/30 bg-red-500/10 hover:bg-red-500/20 text-red-300 hover:text-red-200 transition-all text-sm font-bold disabled:opacity-50 flex items-center gap-2">
                                <span class="material-symbols-outlined text-[18px]">cancel</span> Cancel
                            </button>
                            <button x-show="isReportActionable(selectedReport)" :disabled="reportActionBusy" @click="acceptReport()" class="px-5 py-2.5 rounded-xl bg-green-500 hover:bg-green-600 text-white transition-all text-sm font-bold shadow-[0_0_15px_rgba(34,197,94,0.4)] disabled:opacity-50 flex items-center gap-2">
